...
const Cart = () => {
  ...
  return (
    <div className="bg-half-transparent w-full h-screen fixed nav-item top-0 right-0 ">
      <div className="float-right overflow-auto h-full duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-4 sm:p-8">
        ...
        {cartData?.map((item, index) => (
          <div key={index}>
              ...
              <div className="flex flex-col sm:flex-row items-center  leading-8 gap-5 border-b-1 border-color dark:border-gray-600 p-4">
                ...
                <div>
                  ...
                  {/* Botton de sumar y restar cantidad */}
