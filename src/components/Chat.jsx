...
const Chat = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#42464D] sm:right-52 modal__container" 
    >
      ...
      <div className="mt-5 ">
        {chatData?.map((item, index) => (
          <div key={index} className="flex flex-col sm:flex-row items-center gap-5 border-b-1 border-color p-3 leading-8 cursor-pointer hover:bg-light-gray dark:hover:bg-[#373b41]">
