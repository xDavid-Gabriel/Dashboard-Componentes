...
Cosas que recibe la libreria @syncfusion/ej2-react-grids para poner los titulos medidas lo que llevara dentro,  estos son los que se mapeara con un .map() ======== */
export const kanbanGrid = [
  { headerText: "To Do", 
  // Este keyField es para indicarles donde iran las tareas 
  keyField: "Open", 
  allowToggle: true },
...

  {
    ...
    keyField: "Testing",
    allowToggle: true,
    // Este isExpanded es para que aparesca cerrado la tarea 
    isExpanded: false,
  },
...
// Mi data que se pintara en la grid Componente de <Employees/>
...
const customerGridImage = (props) => (
  <div className="image flex gap-4">
    ...
    />
    <div>
      <p className="text-start">{props.CustomerName}</p>
...
//Aca recibira el areaPrimaryXAxis que llevara dentro del primaryXAxis={areaPrimaryXAxis}
...
//Aca recibira el areaPrimaryYAxis que llevara dentro del primaryYAxis={areaPrimaryYAxis}
...
export const barCustomSeries = [
  {
    ...
    name: "Gold",
    type: "Column",
    // Este es estilos de los numerod de arriba de la barra
    marker: {
      dataLabel: {
        // visible: este es para que se vea esta en true
        visible: true,
        // Arriba
        position: "Top",
...
//Aca recibira el barPrimaryXAxis que llevara dentro del primaryXAxis={barPrimaryXAxis}
export const barPrimaryXAxis = {
  valueType: "Category",
  interval: 1,
  majorGridLines: { width: 0 },
};
//Aca recibira el barPrimaryYAxis que llevara dentro del primaryYAxis={barPrimaryYAxis}
...
//Aca recibira el ColorMappingPrimaryXAxis que llevara dentro del primaryXAxis={ColorMappingPrimaryXAxis}
export const ColorMappingPrimaryXAxis = {
  // esta es reservada para que aparesca el "Category"
  valueType: "Category",
  majorGridLines: { width: 0 },
  title: "Meses",
};

//Aca recibira el ColorMappingPrimaryYAxis que llevara dentro del primaryYAxis={ColorMappingPrimaryYAxis}
...
/* ======== 
Componente de <Customers/>:
Cosas que recibe la libreria @syncfusion/ej2-react-grids para poner los titulos medidas lo que llevara dentro, la paginacion y ordenar los items, estos son los que se mapeara con un .map() ======== */
export const customersGrid = [
  // este tipo es para el checkbox
  { type: "checkbox", width: "50" },
  {
    //Si no tiene el field "No podra ordenarlos y siu lo edita no podra traer la información"
...

  {
    ...
    width: "120",
    textAlign: "Center",
    // esto es para que no se edite el elemento
    isPrimaryKey: true,
  },
];
// Mi data que se pintara en la grid Componente de <Customers/>
...
export const cartData = [
  ...
  },
  {
    ...
    category: "Artículo vegetal",
    price: "$450",
  },
  {
    image: product7,
    name: "helado de caramelo",
    category: "Producto lácteo",
    price: "$190",
  },
];
...
export const chatData = [
  ...
  },
  {
    ...
    desc: "Salma te envió un nuevo mensaje.",
    time: "11:56 AM",
  },
  {
    image: avatar4,
    message: "Nuevo pago recibido",
    desc: "Verifique sus ganancias",
    time: "4:39 AM",
  },
  {
    image: avatar,
    message: "Jolly tareas completadas",
...
/* ======== 
Componente de <Orders/>:
Cosas que recibe la libreria @syncfusion/ej2-react-grids para poner los titulos medidas lo que llevara dentro, la paginacion y ordenar los items, estos son los que se mapeara con un .map() ======== */

export const ordersGrid = [
  {
    //headerText: este es para los titulos
    headerText: "Image",
    //template: este es para poner una funciones jsx en este caso es para las imagenes
    template: function gridOrderImage(props) {
      return (
        <div>
          <img
            className="rounded-xl h-20 w-20"
  ...
  {
    //field: que es campo en español tambien es de la libreria @syncfusion/ej2-react-grids, este tiene que concordar con mi primera propiedad de mi objeto, o data enviada para que llene los campos
    field: "OrderItems",
    headerText: "Item",
    width: "150",
  ...
  },
  {
    ...
    //format: este es para que sea en dolar
    format: "C2",
    textAlign: "Center",
  ...
  {
    headerText: "Status",
    template: function gridOrderStatus(props) {
      return (
        <button
          type="button"
          style={{ background: props.StatusBg }}
...
// Mi data que se pintara en la grid
export const ordersData = [
  {
    ...
    Location: "USA",
    // usados como props en el template:
    Status: "pending",
    StatusBg: "#FB9678",
...
export const scheduleData = [
  {
    // Si o Si nesesita estas propiedades vienen de la libreria del calendario @syncfusion/ej2-react-schedule
    Id: 1,
    Subject: "Explosión de la estrella de Betelgeuse",
    Location: "Lima Perú",
  ...
  {
    Id: 2,
    Subject: "Informe de accidente aéreo",
    Location: "Lima Perú",
  ...
  {
    Id: 4,
    Subject: "Lluvias de meteoros en 2022",
    Location: "Lima Perú",
  ...
  {
    Id: 5,
    Subject: "Vía Láctea como crisol",
    Location: "Lima Perú",
  ...
  {
    Id: 6,
    Subject: "Misterios del triangulo de las bermudas",
    Location: "Bermuda",
  ...
  {
    Id: 7,
    Subject: "Glaciares y copos de nieve",
    Location: "Himalayas",
  ...
  {
    Id: 23,
    Subject: "Observadores del cielo",
    Location: "Greenland",
  ...
  {
    Id: 24,
    Subject: "Datos de los colibríes",
    Location: "California",
...
/* ======== 
Componente de <Line/> que dentro lleva el componente <LineChart/>:
Cosas que recibe la libreria @syncfusion/ej2-react-grids para poner los titulos medidas lo que llevara dentro, estos son los que se mapeara con un .map() ======== */
...
//Aca recibira el LinePrimaryXAxis que llevara dentro del primaryXAxis={LinePrimaryXAxis}

export const LinePrimaryXAxis = {

  valueType: "DateTime",
  labelFormat: "y",
  //Si se quita se para la aplicacion
  intervalType: "Years",
  edgeLabelPlacement: "Shift",
  majorGridLines: { width: 0 },
  background: "white",
};
//Aca recibira el LinePrimaryYAxis que llevara dentro del primaryYAxis={LinePrimaryYAxis}
export const LinePrimaryYAxis = {
  // este es para que sea en porcentaje
  labelFormat: "{value}%",
  rangePadding: "None",
  minimum: 0,
  maximum: 100,
...
/* ======== 
Componente de <Pie/>:
Cosas que recibe la libreria @syncfusion/ej2-react-charts para poner los titulos medidas lo que llevara dentro este solo recibira la data nada mas ======== */
...
// Graficos de la barra de ecommers
...
//De la libreria Stacked primaryXAxis Estilacion de las lineas en el eje X
...
//De la libreria Stacked primaryYAxis Estilacion de las lineas en el eje Y
...
export const FinancialPrimaryXAxis = {
  ...
  //Para que me muestre en un mensaje donde estoy en los meses del año
...
/* ======== 
Componente de <Financial/>:
Cosas que recibe la libreria @syncfusion/ej2-react-charts para poner los titulos medidas lo que llevara dentro ======== */ 
...
export const PyramidData = [
  { x: "Dulces", y: 120, text: "120 cal" },
  { x: "Leche, Yogurt, Queso", y: 435, text: "435 cal" },
  { x: "Verduras", y: 470, text: "470 cal" },
  { x: "Carne, Aves, Pescado", y: 475, text: "475 cal" },
  { x: "Frutas", y: 520, text: "520 cal" },
  { x: "Pan, Arroz, Pasta", y: 930, text: "930 cal" },
];
