      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl w-full">
          <div className="flex flex-wrap justify-center sm:justify-between">
            ...
            <p className="font-semibold text-xl mx-3 my-8 sm:my-0">Actualizaciones de ingresos</p>
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 sm:pr-10">
              <div>
                <p>
            ...
            {/* Grafico de Barras*/}
            <div style={{width:"300px"}} className="md:w-2/4">
